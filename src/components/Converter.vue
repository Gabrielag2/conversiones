...
export default {
  ...
  methods:{
      ...
      toCelsius: function(value,unit){   // converts a temperatura value to its corresponding value in celsius
        switch(unit){
            case("C"):
                return value;
            case("F"):
              ...
              switch(this.physicalQuantity.name){    // check in which physicalQuantity we are
                case("Tiempo"): {
                    /* ------------T I M E-------------*/
                        ...
                        default:
                            console.log("Error while converting tiempo - resultUnit not detected!");
                            return "...";
                         }
                }
                  /* ----------------------------*/
                 case("Longitud"): {
                    /* ------------L E N G T H-------------*/
                        ...
                        default:
                            console.log("Error while converting longitud - resultUnit not detected!");
                            return "...";
                        }
                 }
                  /* ----------------------------*/
                  case("Temperatura"): {
                    /* ------------T E M P E R A T U R E-------------*/
                        ...
                        default:
                            console.log("Error while converting temperatura - resultUnit not detected!");
                            return "...";
                        }
                  }
                  /* ----------------------------*/
